...
Original file is located at
    https://colab.research.google.com/drive/1Y9Y8wcIzJ0tt0yXu8i6JEZWFYpS-iWtW
"""
...
"""**Reasoning**:
The error indicates that stratification is not possible because at least one class has only a single sample. Given the very small dataset size (5 samples), stratification is not appropriate or necessary. The code needs to be modified to remove stratification.
